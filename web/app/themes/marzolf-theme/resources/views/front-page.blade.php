  ...
  <div class="front-page">
      ...
      <div class="container-modern relative z-10">
        <div class="max-w-3xl">
          ...
          <div class="flex flex-col sm:flex-row gap-4">
            <a href="#contact" class="btn-primary bg-white text-green-800 hover:bg-green-50">
              Schedule a Consultation
              <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/>
              </svg>
            </a>
            <a href="#team" class="inline-flex items-center justify-center px-8 py-4 rounded-xl font-semibold text-white border-2 border-white/30 hover:bg-white/10 transition backdrop-blur-sm">
              Meet Our Team
            </a>
          </div>
    ...
    <section id="services" class="services section-padding bg-white">
      <div class="container-modern">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {{-- Service 1 --}}
          <div class="service-card bg-white rounded-2xl p-8 card-hover border border-neutral-100">
            <div class="w-14 h-14 rounded-2xl flex items-center justify-center mb-6" style="background: var(--color-primary-bg);">
