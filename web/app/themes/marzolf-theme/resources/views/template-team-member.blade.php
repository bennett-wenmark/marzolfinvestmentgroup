      ...
      <section class="team-hero bg-gray-50 py-16">
        <div class="container mx-auto px-4">
          <div class="max-w-4xl mx-auto">
            <a href="{{ home_url('/') }}" class="inline-flex items-center hover:opacity-80 mb-8 transition no-underline" style="color: var(--color-primary);">
            ...
            <div class="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div class="w-full md:w-2/3">
                ...
                @if ($title = get_post_meta(get_the_ID(), 'team_title', true))
                  <p class="text-xl font-medium mb-6" style="color: var(--color-primary);">{{ $title }}</p>
                @endif
