...
@section('content')
  @while(have_posts()) @php(the_post())
    <article class="services-overview-page">
      ...
      <section class="services-grid py-12 bg-white">
        <div class="container mx-auto px-4">
          ...
          <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <a href="{{ get_permalink(21) }}" class="block p-6 bg-gray-50 rounded-xl hover:shadow-lg transition no-underline">
            ...
            <a href="{{ get_permalink(22) }}" class="block p-6 bg-gray-50 rounded-xl hover:shadow-lg transition no-underline">
            ...
            <a href="{{ get_permalink(23) }}" class="block p-6 bg-gray-50 rounded-xl hover:shadow-lg transition no-underline">
            ...
            <a href="{{ get_permalink(24) }}" class="block p-6 bg-gray-50 rounded-xl hover:shadow-lg transition no-underline">
            ...
            <a href="{{ get_permalink(25) }}" class="block p-6 bg-gray-50 rounded-xl hover:shadow-lg transition no-underline">
            ...
            <a href="{{ get_permalink(26) }}" class="block p-6 bg-gray-50 rounded-xl hover:shadow-lg transition no-underline">
